...
namespace WpfApp13
{
    ...
    partial void DeleteParcele(Parcele instance);
		...
		public KatastarDataContext() : 
				base(global::WpfApp13.Properties.Settings.Default.KatastarConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnNazivChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="KatastarskeOpstine_Objekti", Storage="_Objektis", ThisKey="IDKatOpstina", OtherKey="IDKatOpstine")]
    ...
    partial void OnIDKatOpstineChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Vlasnik", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="KatastarskeOpstine_Objekti", Storage="_KatastarskeOpstine", ThisKey="IDKatOpstine", OtherKey="IDKatOpstina", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._KatastarskeOpstine.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._IDKatOpstine = value.IDKatOpstina;
					}
					else
					{
    ...
    partial void OnVlasnistvoChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Vlasnistvo", DbType="NVarChar(50)")]
